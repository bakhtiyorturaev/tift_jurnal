...
class Magazine(models.Model):
    ...
    which_number = models.CharField(max_length=50, verbose_name='Jurnal soni', help_text='Namuna: 2025 yil | 1-son | Yanvar')
...
class ArticleCategories(models.Model):
    ...
    magazine = models.ForeignKey(Magazine, on_delete=models.CASCADE, related_name='categories',
                                 verbose_name='Jurnal soni', blank=True, null=True)
...
class Article(models.Model):
    magazine = models.ForeignKey(Magazine, on_delete=models.CASCADE, related_name='articles', verbose_name='Jurnali',
