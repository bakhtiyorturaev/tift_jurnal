    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yuriqnoma_uz', models.TextField(blank=True, null=True, verbose_name="Yo'riqnoma (UZ)")),
                ('yuriqnoma_ru', models.TextField(blank=True, null=True, verbose_name="Yo'riqnoma (RU)")),
                ('yuriqnoma_en', models.TextField(blank=True, null=True, verbose_name="Yo'riqnoma (EN)")),
            ],
            options={
