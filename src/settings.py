...
# from bosh_sahifa.storage import CustomStorage
#
# CUSTOM_STORAGE_LOCATION = 'path/to/custom/storage'
# # CUSTOM_STORAGE_BASE_URL = '/media/custom/'
#
...
CKEDITOR_5_CONFIGS = {
'default': {
    'toolbar': ['heading', '|', 'bold', 'italic', 'link', 'undo', 'redo', 'clipboard', 'alignment',
...
# CKEDITOR_5_FILE_UPLOAD_PERMISSION = "staff"  # Possible values: "staff", "authenticated", "any"_UPLOAD_PERMISSION = "staff"